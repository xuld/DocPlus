...
namespace DocPlus.Javascript {
    ...
    /// 表示一个变量。
    /// </summary>
    public class Variant1 :IEnumerable<KeyValuePair<string, Variant>> {
        ...
        public string Author {
            get {
                return GetValue1(CommentNode1.Author);
            }
            set {
                SetValue1(CommentNode1.Author, value);
            }
        }

        public string ProjectDescription {
            get {
                return GetValue1(CommentNode1.ProjectDescription);
            }
            set {
                SetValue1(CommentNode1.ProjectDescription, value);
            }
        }

        public string License {
            get {
                return GetValue1(CommentNode1.License);
            }
            set {
                SetValue1(CommentNode1.License, value);
            }
        }

        public string Version {
            get {
                return GetValue1(CommentNode1.Version);
            }
            set {
                SetValue1(CommentNode1.Version, value);
            }
        }

        public string FileOverview {
            get {
                return GetValue1(CommentNode1.FileOverview);
            }
            set {
                SetValue1(CommentNode1.FileOverview, value);
            }
        }

        public string File {
            get {
                return GetValue1(CommentNode1.File);
            }
            set {
                SetValue1(CommentNode1.File, value);
            }
        }

        public string Requires {
            get {
                return GetValue1(CommentNode1.Requires);
            }
            set {
                SetValue1(CommentNode1.Requires, value);
            }
        }
        ...
        ///// 获取当前注释中表示成员的类型的标签。
        ///// </summary>
        //public CommentNodeNames Member {
        //    set {
        //        if (value == CommentNodeNames.Class) {
        //            MemberType = MemberType.Class;
        //            NamespaceSetter = MemberOf == null ? DisplayName : (MemberOf + "." + DisplayName);
        //        } else if (value == CommentNodeNames.Interface) {
        //            MemberType = MemberType.Interface;
        //            NamespaceSetter = MemberOf == null ? DisplayName : (MemberOf + "." + DisplayName);
        //        } else if (value == CommentNodeNames.Config) {
        //            MemberType = MemberType.Config;
        //        } else if (value == CommentNodeNames.Enum) {
        //            MemberType = MemberType.Enum;
        //        } else if (value == CommentNodeNames.Event) {
        //            MemberType = MemberType.Event;
        //        } else if (value == CommentNodeNames.Field) {
        //            MemberType = MemberType.Field;
        //        } else if (value == CommentNodeNames.Method) {
        //            MemberType = MemberType.Method;
        //        } else if (value == CommentNodeNames.Property) {
        //            MemberType = MemberType.Property;
        //        } else if (value == CommentNodeNames.Getter) {
        //            MemberType = MemberType.PropertyGetter;
        //        } else if (value == CommentNodeNames.Setter) {
        ...
        /// 获取当前注释中表示访问属性的标签。
        /// </summary>
        public CommentNode1 MemberAccessNode {
            //get {
            //    if (value == CommentNodeNames.Public) {
            //        member.MemberAccess = MemberAccess.Public;
            //    } else if (dc.MemberAccess == CommentNodeNames.Protected) {
            //        member.MemberAccess = MemberAccess.Protected;
            //    } else if (dc.MemberAccess == CommentNodeNames.Private) {
            //        member.MemberAccess = MemberAccess.Private;
            //    } else if (dc.MemberAccess == CommentNodeNames.Namespace) {
            //        member.MemberAccess = MemberAccess.Namespace;
            //    } else if (dc.MemberAccess == CommentNodeNames.Internal) {
            //        member.MemberAccess = MemberAccess.Internal;
            //    } else if (dc.MemberAccess == CommentNodeNames.ProtectedInternal) {
            //        member.MemberAccess = MemberAccess.ProtectedInternal;
            //    }
            //}
            set {
                if (value == CommentNode1.Public) {
                    MemberAccess = MemberAccess.Public;
                } else if (value == CommentNode1.Protected) {
                    MemberAccess = MemberAccess.Protected;
                } else if (value == CommentNode1.Private) {
                    MemberAccess = MemberAccess.Private;
                } else if (value == CommentNode1.Namespace) {
                    MemberAccess = MemberAccess.Namespace;
                } else if (value == CommentNode1.Internal) {
        ...
        /// 获取当前注释中表示属性的标签。
        /// </summary>
        public CommentNode1 MemberAttributeNode {
          //  get;
            set {
                if (value == CommentNode1.Abstract) {
                    MemberAttribute = MemberAttributes.Abstract;
                } else if (value == CommentNode1.Override) {
                    MemberAttribute = MemberAttributes.Override;
                } else if (value == CommentNode1.Static) {
                    MemberAttribute = MemberAttributes.Static;
                } else if (value == CommentNode1.Virtual) {
        ...
        public string[] Extends {
            get {
                return _otherTags[CommentNode1.Extends];
            }
            set {
                _otherTags[CommentNode1.Extends] = value;
            }
        }

        public string[] Implements {
            get {
                return _otherTags[CommentNode1.Implements];
            }
            set {
                _otherTags[CommentNode1.Implements] = value;
            }
        }
        ...
        public string DefaultValue {
            get {
                return GetValue1(CommentNode1.DefaultValue);
            }
            set {
                SetValue1(CommentNode1.DefaultValue, value);
            }
        }
        ...
        string GetValue1(CommentNode1 node) {
            return _otherTags.ContainsKey(node) ? _otherTags[node][0] : null;
        }

        void SetValue1(CommentNode1 node, string value) {
            _otherTags[node] = new string[] { value };
        }

        public string Summary {
            get {
                return GetValue1(CommentNode1.Summary);
            }
            set {
                SetValue1(CommentNode1.Summary, value);
            }
        }

        public string Remark {
            get {
                return GetValue1(CommentNode1.Remark);
            }
            set {
                SetValue1(CommentNode1.Remark, value);
            }
        }

        public string Example {
            get {
                return GetValue1(CommentNode1.Example);
            }
            set {
                SetValue1(CommentNode1.Example, value);
            }
        }

        public string Syntax {
            get {
                return GetValue1(CommentNode1.Syntax);
            }
            set {
                SetValue1(CommentNode1.Syntax, value);
            }
        }

        public string Category {
            get {
                return GetValue1(CommentNode1.Category);
            }
            set {
                SetValue1(CommentNode1.Category, value);
            }
        }

        public string[] See {
            get {
                return _otherTags[CommentNode1.See];
            }
            set {
                _otherTags[CommentNode1.See] = value;
            }
        }

        public string[] SeeAlso {
            get {
                return _otherTags[CommentNode1.SeeAlso];
            }
            set {
                _otherTags[CommentNode1.SeeAlso] = value;
            }
        }

        public string Since {
            get {
                return GetValue1(CommentNode1.Since);
            }
            set {
                SetValue1(CommentNode1.Since, value);
            }
        }

        public string Deprecated {
            get {
                return GetValue1(CommentNode1.Deprecated);
            }
            set {
                SetValue1(CommentNode1.Deprecated, value);
            }
        }
        ...
        public string[] Alias {
            get {
                return _otherTags[CommentNode1.Alias];
            }
            set {
                _otherTags[CommentNode1.Alias] = value;
            }
        }
        ...
        ///// <returns></returns>
        //public CommentNodeNames GetCommentNode(CommentNodeType type) {
        ...
        Map<CommentNode1, string[]> _otherTags = new Map<CommentNode1, string[]>();
        ...
        public string[] this[CommentNode1 node] {
            get {
        ...
        public bool ContainsKey(CommentNode1 node) {
